...
object BinaryVectorInsertDemo {

  private val log = LoggerFactory.getLogger(getClass)

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().master("local[*]")
      .appName("BinaryVectorDemo")
      .getOrCreate()
    ...
    val uri = ""
    val token = ""
    val collectionName = "binary_vector_test"
    val filePath = "data/insert_demo/binary_vector_demo.json"

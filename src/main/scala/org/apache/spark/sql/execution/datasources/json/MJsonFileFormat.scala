...
class MJsonFileFormat extends TextBasedFileFormat with DataSourceRegister {
  override val shortName: String = "mjson"
  ...
  override def prepareWrite(
    ...
    new OutputWriterFactory {
      override def newInstance(
        ...
        new MJsonOutputWriter(path, parsedOptions, dataSchema, context)
      }
  ...
  override def equals(other: Any): Boolean = other.isInstanceOf[MJsonFileFormat]

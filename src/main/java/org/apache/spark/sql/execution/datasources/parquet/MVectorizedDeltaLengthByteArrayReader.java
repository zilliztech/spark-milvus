 ...
 * interface.
 */
public class MVectorizedDeltaLengthByteArrayReader extends MVectorizedReaderBase implements
        MVectorizedValuesReader {

  private final MVectorizedDeltaBinaryPackedReader lengthReader;
  private ByteBufferInputStream in;
  private WritableColumnVector lengthsVector;
  private int currentRow = 0;

  MVectorizedDeltaLengthByteArrayReader() {
    lengthReader = new MVectorizedDeltaBinaryPackedReader();
  }

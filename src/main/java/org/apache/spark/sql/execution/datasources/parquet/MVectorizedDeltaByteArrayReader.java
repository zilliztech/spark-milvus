 ...
 * interface.
 */
public class MVectorizedDeltaByteArrayReader extends MVectorizedReaderBase
    implements MVectorizedValuesReader, RequiresPreviousReader {

  private final MVectorizedDeltaBinaryPackedReader prefixLengthReader;
  private final MVectorizedDeltaLengthByteArrayReader suffixReader;
  ...
  MVectorizedDeltaByteArrayReader() {
    this.prefixLengthReader = new MVectorizedDeltaBinaryPackedReader();
    this.suffixReader = new MVectorizedDeltaLengthByteArrayReader();
  ...
  public void setPreviousReader(ValuesReader reader) {
    if (reader != null) {
      this.previous = ((MVectorizedDeltaByteArrayReader) reader).previous;
    }
  }

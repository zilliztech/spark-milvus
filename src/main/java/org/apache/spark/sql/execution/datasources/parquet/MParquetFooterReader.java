 ...
 */
public class MParquetFooterReader {
  public static ParquetMetadata readFooter(Configuration configuration,
    ...
    return readFooter(MilvusBinlogInputFile.fromPath(file, configuration), filter);
  }

  public static ParquetMetadata readFooter(Configuration configuration,
                                           FileStatus fileStatus, ParquetMetadataConverter.MetadataFilter filter) throws IOException {
    return readFooter(MilvusBinlogInputFile.fromStatus(fileStatus, configuration), filter);
  }

  private static ParquetMetadata readFooter(MilvusBinlogInputFile inputFile,

...
public final class MParquetDictionary implements Dictionary {
  private org.apache.parquet.column.Dictionary dictionary;
  private boolean needTransform = false;

  public MParquetDictionary(org.apache.parquet.column.Dictionary dictionary, boolean needTransform) {

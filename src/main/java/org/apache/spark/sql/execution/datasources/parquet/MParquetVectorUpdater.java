...
public interface MParquetVectorUpdater {
  /**
   ...
   */
  void skipValues(int total, MVectorizedValuesReader valuesReader);
   ...
   * @param valuesReader reader to read values from
   */
  void readValue(int offset, WritableColumnVector values, MVectorizedValuesReader valuesReader);

...
final class MParquetLogRedirector implements Serializable {
  ...
  // ignored
  static final MParquetLogRedirector INSTANCE = new MParquetLogRedirector();

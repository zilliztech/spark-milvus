...
public class MParquetVectorUpdaterFactory {
  ...
  public MParquetVectorUpdater getUpdater(ColumnDescriptor descriptor, DataType sparkType) {
        ...
        if (sparkType == TimestampNTZType$.MODULE$) {
          ...
          if (!shouldConvertTimestamps()) {
            ...
            if ("CORRECTED".equals(int96RebaseMode)) {
              ...
              return new BinaryToSQLTimestampConvertTzRebaseUpdaterM(
                failIfRebase,
                convertTz,
                int96RebaseTz);
            }
...
//        return new BinaryUpdater();
  ...
  private static class BooleanUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
        WritableColumnVector values,
        MVectorizedValuesReader valuesReader) {
      valuesReader.readBooleans(total, values, offset);
    }

    @Override
    public void skipValues(int total, MVectorizedValuesReader valuesReader) {
  ...
  static class IntegerUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class UnsignedIntegerUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class ByteUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class ShortUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class IntegerWithRebaseUpdater implements MParquetVectorUpdater {
  ...
  private static class LongUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class DowncastLongUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class UnsignedLongUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class LongWithRebaseUpdater implements MParquetVectorUpdater {
    private final boolean failIfRebase;
  ...
  private static class LongAsMicrosUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class LongAsMicrosRebaseUpdater implements MParquetVectorUpdater {
    private final boolean failIfRebase;
    private final String timeZone;
  ...
  private static class FloatUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class DoubleUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class BinaryUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class BinaryToSQLTimestampUpdater implements MParquetVectorUpdater {
    @Override
    public void readValues(
        int total,
        int offset,
  ...
  private static class BinaryToSQLTimestampConvertTzUpdater implements MParquetVectorUpdater {
    private final ZoneId convertTz;
  ...
  private static class BinaryToSQLTimestampRebaseUpdater implements MParquetVectorUpdater {
    private final boolean failIfRebase;
    private final String timeZone;
  ...
  private static class BinaryToSQLTimestampConvertTzRebaseUpdaterM implements MParquetVectorUpdater {
    private final boolean failIfRebase;
    private final ZoneId convertTz;
    private final String timeZone;

    BinaryToSQLTimestampConvertTzRebaseUpdaterM(
  ...
  private static class FixedLenByteArrayUpdater implements MParquetVectorUpdater {
  ...
  private static class FixedLenByteArrayAsIntUpdater implements MParquetVectorUpdater {
    private final int arrayLen;
  ...
  private static class FixedLenByteArrayAsLongUpdater implements MParquetVectorUpdater {
    private final int arrayLen;
